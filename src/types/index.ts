...
export interface PromotionalOfferSignatureRequest {
    productId: string;
    offerIdentifier: string;
    applicationUsername: string; // User ID
    nonce: string; // UUID generated by client
    // timestamp is generated server-side for security
}
